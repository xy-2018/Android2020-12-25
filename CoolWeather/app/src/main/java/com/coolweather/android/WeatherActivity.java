...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String bingPic = prefs.getString("bing_pic", null);//尝试缓存中读取
        if (bingPic != null) {
     ...
     * 根据天气Id请求城市天气信息
     */
    public void requestWeather(final String weatherId_tem){
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId_tem + "&key=d1c555b540e248c6921e2efcbb4092a5"; // 这里的key设置为第一个实训中获取到的API Key
        // 组装地址并发出请求
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if(weather!=null && "ok".equals(weather.status)){
                            ...
                            editor.apply();
                            weatherId=weather.basic.weatherId;//刷新不改城市
                            showWeatherInfo(weather);
